    ...
    var handleSidebarMenu = function () {
        jQuery('.page-sidebar').on('click', 'li > a', function (e) {
                ...
                if (sub.is(":visible")) {
                    ...
                    jQuery('.indicatior', jQuery(this)).removeClass("selected");
                    jQuery(this).parent().removeClass("open active");
                    sub.slideUp(200, function () {
                            handleSidebarAndContentHeight();
                        });
                } else {
                    if(lastSidebarMenuItem ){
                        jQuery('.arrow', jQuery(lastSidebarMenuItem)).removeClass("open");
                        jQuery('.indicatior', jQuery(lastSidebarMenuItem)).removeClass("selected");
                        jQuery(lastSidebarMenuItem).parent().removeClass("open active");
                        sub.slideUp(200, function () {
                            handleSidebarAndContentHeight();
                        });
                    ...
                    jQuery('.indicatior', jQuery(this)).addClass("selected");
                    jQuery(this).parent().addClass("open active");
                    sub.slideDown(200, function () {
                            handleSidebarAndContentHeight();
                        });

                    lastSidebarMenuItem = this;
                }
